...
/*
@Controller
public class AlbumUpdateController2 {
	...
	public ModelAndView doActionGet(@RequestParam(value="num",required=true) String num,
			@RequestParam(value="pageNumber",required=true) String pageNumber,
			@RequestParam(value="pageSize",required=true) String pageSize,
			AlbumBean album,HttpServletRequest request){ // 1
